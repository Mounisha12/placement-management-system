...
<body>	
	<div class="bgimage">
		...
		<img src="avatar.png" class="avatar">
			<li><a href="student/student2.php">Add student Details</a></li>
		</div>
			<div class="right2text">
			<img src="avatar.png" class="avatar">
			<li><a href="student/modified1.php">View student Details</a></li>
			</div>
			<div class="right3text">
			<img src="avatar.png" class="avatar">
			<li><a href="student/student1.php">View Student Logs</a></li>
			</div>
